<div class="modal-dialog modal-md">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">Edit Mems</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        
        <form action="{{ route('admin.reporting.mems.update') }}" class="submit-form" method="POST">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control valid-control numbers" name="Booking_number">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    var data = <?php echo json_encode($mems_data) ?>;
