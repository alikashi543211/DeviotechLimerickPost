...
<div class="card">
    ...
    <div class="card-header">
        <button class="btn btn-link" type="button"> <span><i class="fa fa-user"></i></span> General (New) Information</button>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <select class="opening1 valid-control" name="opening">
                    ...
                    <option value="New1" class="new-o" selected>New</option>
                    <option value="Existing Opening">Existing</option>
                </select>
                @error('opening')
                <span class="error">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row" id="">
                    ...
                    <input type="hidden" class="verse_count" name="verse_count" value="">
                    ...
                    <div class="col-md-12 provided_block">
                        <div class="row" id="provided-item-1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mem_verse_no_of_words[]" placeholder="New Ref no. " class="numbers mems_pro_no_of_words valid-control mem_verse_no_of_words">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="provided_verse_cost valid-control mem_verse_price" name="mem_verse_price[]" value="" readonly>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 p-0 show_on_cash hidden">
                        <div class="col-lg-6 show-on-new">
                            ...
                            <input type="text" name="mems_cash_receipt_no" class="valid-control numbers">
                            @error('mems_cash_receipt_no')
                            <span class="error">
                                <strong>{{ $message }}</strong>
                            </span>
                            @enderror
